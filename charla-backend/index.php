<?php
/**
 * Asistente Virtual IA Backend - Portfolio Rubén Sans Acevedo
...
// Manejar GET requests para testing
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    echo json_encode([
        'status' => 'ok',
        'message' => 'Charla IA Backend funcionando',
        ...
        'endpoints' => [
            ...
            'GET /test.php' => 'Test de conectividad',
            'GET /simple-test.php' => 'Test básico'
        ]
    ]);
    exit();
}

// Solo permitir POST requests para el chat
